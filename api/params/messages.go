...
func (b *MessagesDeleteBuilder) Cmids(v []int) *MessagesDeleteBuilder {
	b.Params["cmids"] = v
	return b
}
...
// MessageEventAnswer builder
//
// https://vk.com/dev/sendMessageEventAnswer

type MessageEventAnswerBuilder struct {
	api.Params
}

// MessageEventAnswer func.
func NewMessageEventAnswerBuilder() *MessageEventAnswerBuilder {
	return &MessageEventAnswerBuilder{api.Params{}}
}

// MessageEventAnswer func.
func (b *MessageEventAnswerBuilder) EventID(v string) *MessageEventAnswerBuilder {
	b.Params["event_id"] = v
	return b
}
